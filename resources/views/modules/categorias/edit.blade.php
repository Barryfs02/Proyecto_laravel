    ...
    <div class="container">
      <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
          <div>
            <h3 class="fw-bold mb-3">EDITAR CATEGORIA</h3>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <p>Modificar la información de la categoría</p>
              </div>
              <div class="card-body">
                <form action="{{ route('categorias.update', $item->id) }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input name="nombre" class="form-control" id="nombre" value="{{ $item->nombre }}">
                  </div>

                  <div class="d-flex gap-2">
                    <button class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i>Guardar</button>
                    <a class="btn btn-info text-white" href="{{ route('nueva_categoria') }}"><i class="fa-brands fa-linux"></i>Cancelar</a>
                  </div>
                </form>
              </div>
            </div>
